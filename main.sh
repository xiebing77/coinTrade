...
python $base_dir/main.py -t blz -b eth -a 0 -d 8 -p 8 -g 0.05 -n 5 -r 2000 -s 0 -e binance
...
python $base_dir/main.py -t lba -b eth -a 0 -d 8 -p 8 -g 0.05 -n 5 -r 2000 -s 0 -e okex
